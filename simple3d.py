...
def run():
    ...
    viewing_distance = calculate_viewing_distance(math.radians(fov), SCREEN_SIZE[0])

    # Create the list of points along the edge of the cube
    ...
    while True:
        ...
        if pressed_keys[K_w]:
            ...
            w = SCREEN_SIZE[0]
            viewing_distance = calculate_viewing_distance(math.radians(fov), w)
        ...
        col = (50, 255, 50)
        cam_text = font.render("camera=" + str(camera_position), True, (255, 255, 255))
        screen.blit(cam_text, (5, 5))
        fov_text = font.render("field of view=%i" % int(fov), True, (255, 255, 255))
        screen.blit(fov_text, (5, 35))
        txt = "viewing distance= %.3f" % viewing_distance
        d_text = font.render(txt, True, (255, 255, 255))
